...
class ControllerCatalogProduct extends Controller {
	...
	public function filter() {
  	...
  	protected function getForm() {
		...
		$this->data['entry_textstart'] = $this->language->get('entry_textstart');
		...
		if (isset($this->error['textstart'])) {
			$this->data['error_textstart'] = $this->error['textstart'];
		} else {
			$this->data['error_textstart'] = '';
		}
