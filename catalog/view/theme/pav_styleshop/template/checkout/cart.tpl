			...
			<div class="cart-module">
				<div id="coupon" class="content" style="display: <?php echo ($next == 'coupon' ? 'block' : 'none'); ?>;">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" role="form">
						...
						&nbsp;
						<input type="submit" value="<?php echo $button_coupon; ?>" class="button btn btn-theme-default" />
					</form>
				</div>
				...
				<div id="voucher" class="content" style="display: <?php echo ($next == 'voucher' ? 'block' : 'none'); ?>;">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" role="form">
						...
						&nbsp;
						<input type="submit" value="<?php echo $button_voucher; ?>" class="button btn btn-theme-default" />
					</form>
				</div>
				...
				<div id="reward" class="content" style="display: <?php echo ($next == 'reward' ? 'block' : 'none'); ?>;">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" role="form">
						...
						&nbsp;
						<input type="submit" value="<?php echo $button_reward; ?>" class="button btn btn-theme-default" />
					</form>
				</div>
				...
				<div id="shipping" class="content" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
					...
					<input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="btn btn-theme-default" />
				</div>
			</div>
		<?php } ?>
  ...
  <div class="row">
	<div  class="col-lg-9 col-md-9">  
		<div class="buttons clearfix">
			<div class="pull-right right"><a href="<?php echo $checkout; ?>" class="button btn btn-theme-default"><?php echo $button_checkout; ?></a></div>
			<div class="center pull-left"><a href="<?php echo $continue; ?>" class="button btn btn-theme-default "><?php echo $button_shopping; ?></a></div>
		</div>
	</div>  
