				...
				<div class="row">
					<div class="content col-sm-6">
						...
						<table class="form">
							...
							<tr>
								<td>
									<input type="text" pattern="[A-Za-zА-Яа-яЁё]{2,}" class="form-control" name="firstname" value="<?php echo $firstname; ?>" />
							...
							<tr>
								<td>
									<input type="text" pattern="[A-Za-zА-Яа-яЁё]{2,}" class="form-control" name="lastname" value="<?php echo $lastname; ?>" />
