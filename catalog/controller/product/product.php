...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
       ...
       $this->document->setTitle('Купить '.$product_info['model'].' в интернет-магазине мебели Dinas Wood');
			...
			$this->document->setDescription('Интернет-магазин DinasWood предлагает купить '.$product_info['name'].' недорого с доставкой по всей России. Быстро, качественно и в срок. Тел: +8 (919) 187 47 49');
			...
			$this->data['startto'] = $product_info['startto'];
